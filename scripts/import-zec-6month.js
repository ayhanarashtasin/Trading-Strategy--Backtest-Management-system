/**
 * Import the LAST-6-MONTHS backtest of every optimised ZECUSDT 5m configuration.
 *
 *   window     2026-03-15 -> 2026-09-15 (184 days)
 ...
 *
 *   node scripts/import-zec-6month.js [--dry]
 */
require("./load-env");
const fs = require("fs");
